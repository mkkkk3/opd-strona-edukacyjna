...
export default function Custom404() {
  return (
    <React.Fragment>
      ...
      <div className="w-full h-[32rem] relative bg-page1">
          ...
          <div className="w-full h-full md:grid md:grid-cols-12">
            <div className="w-full h-1/2 md:h-full md:col-span-5">
              <div className="w-full h-full flex items-center justify-center">
                <span className="font-page text-2xl sm:text-5xl md:text-4xl lg:text-5xl text-pageMenu font-extrabold tracking-wide text-center overflow-hidden p-5">
                  nie znaleziono...
                </span>
              </div>
            </div>
